...
# 1. LOAD MODEL
# Make sure 'gboost_model.pkl' is in your GitHub folder
model = pickle.load(open('gboost_model.pkl','rb'))

# 2. INPUT FEATURES (Define variables BEFORE using them)
...
input_features = pd.DataFrame({
    ...
    'ChestPainType_TA': [ChestPainType_TA], 'st_Slope': [st_Slope]
})

# 5. SCALING
# Note: Realistically, you should load a saved scaler.pkl from your training.
# Using fit_transform on a single row will turn all values to 0.
